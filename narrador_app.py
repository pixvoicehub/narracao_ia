...
#
# OBJETIVO: Este é o microsserviço "Ator de IA", usando a sintaxe híbrida
# correta para a biblioteca instalada no Render.
#
# VERSÃO: 14.0 - Versão final e estável.
# =========================================================================
...
def generate_audio_endpoint():
    ...
    try:
        ...
        # 2. [A CHAVE DA CORREÇÃO] O conteúdo é passado diretamente como uma lista de strings,
        #    sem usar 'types.Part', o que causava o erro anterior.
        contents = [text_to_narrate]
        
        # 3. A configuração de áudio usa a estrutura 'types.GenerateContentConfig',
