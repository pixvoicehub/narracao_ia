...
#
# VERSÃO: 16.0 - Versão definitiva com a sintaxe mais simples e robusta,
# resolvendo o erro 'Unknown field for GenerationConfig: voice'.
# =========================================================================
...
def generate_audio_endpoint():
    ...
    # 2. Comunicação com a API de TTS (SINTAXE FINAL E CORRETA)
    try:
